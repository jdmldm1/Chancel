                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md">
                          {(participant.user.displayName || participant.user.username || participant.user.name || '?').charAt(0).toUpperCase()}
                        </div>

                        {/* User info */}
                        <div className="flex-1">
                          <p className="text-sm font-semibold text-gray-900">{participant.user.displayName || participant.user.username || participant.user.name || 'Unknown'}</p>
